...
var Field = /** @class */ (function (_super) {
    ...
    function Field(ref, name, initialValues, rules, validateMessages, required, label, message, validateTrigger) {
        ...
        _this.ref.on(function (trigger, value, extraInfo) { return __awaiter(_this, void 0, void 0, function () {
            var props;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(trigger === 'onChange')) return [3 /*break*/, 2];
                        this.setValue(value);
                        this.touched = true;
                        // 触发校验，需要在 onValueChange 之前执行
                        return [4 /*yield*/, Promise.all(this.validateTrigger.map(function (item) {
                                if (item === trigger) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/];
                    case 2:
                        if (trigger === 'didUnmount') {
                            this.emit('didUnmount');
                        }
                        else if (trigger === 'deriveDataFromProps') {
                            props = extraInfo ? extraInfo : this.ref.getProps();
                            if ((value.name && value.name !== props.name) ||
                                ...
                                this.create(value.name, get(initialValues, value.name), this.formRules[value.name], validateMessages, value.required, value.message, value.label, value.validateTrigger, true);
                            }
                        ...
                        _a.label = 3;
                    case 3:
                        this.validateTrigger.forEach(function (item) {
                            if (item === trigger) {
                                _this.validate();
                            }
                        });
