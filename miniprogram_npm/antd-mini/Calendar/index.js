    ...
    methods: {
        ...
        measurementFn: function () {
            ...
            Promise.all([
                ...
                .then(function (_a) {
                var bodyContainer = _a[0], cellsContainer = _a[1], cellContainer = _a[2], titleContainer = _a[3];
                // 滚动的时候 top 和 bottom 等尺寸会变
                // 所以只能依赖 height 来计算
                var paddingHeight = bodyContainer.height -
                    cellsContainer.height -
                    titleContainer.height;
                var monthTitleHeight = titleContainer.height + paddingHeight;
                _this.setData({
                    elementSize: {
